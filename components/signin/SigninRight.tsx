...
import {Box, InputGroup, Input, InputRightElement, Checkbox, Text, Button} from '@chakra-ui/react';
...
export default  function SigninRight ({}: Props) : ReactElement {
    ...
    const { values, errors, handleChange, handleSubmit } = useValidation(initialState, loginValidator, loginUser)
            ...
            >
                <form onSubmit={handleSubmit}>
                    ...
                    >
                            ...
                            />
                            {(errors as LoginErrors).email && <Text color='red'>{(errors as LoginErrors).email}</Text>}
                        <InputGroup>
                            <Input 
                            variant='filled'
                            backgroundColor='E9EFF6'
                        ...
                        {(errors as LoginErrors).password && <Text color='red'>{(errors as LoginErrors).password}</Text>}
                    </Box>
                    <Box
                    display='flex'
                    ...
                    mt='2em'
                    >
                        { apiError && <Text textAlign="center" color="red">{apiError}</Text>}
